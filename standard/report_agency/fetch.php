...
if($_POST["query"] != '')
{
	...
	$query = "SELECT * , a.standard_status,x.statuss_name AS name_status ,
	a.standard_idtb,bb.type_name AS name_type , a.standard_idtb,cc.group_name AS name_group ,
	a.standard_idtb,dd.department_name AS name_depart , a.standard_idtb,e.fileupload AS name_file , a.standard_idtb,ff.agency_name AS name_agency
	FROM main_std a 
	-- status
	...
	WHERE f.agency_id IN (".$search_text.") 
	";
}
else
{
